...
<html lang="ru">
    ...
    <body class="body flex-column d-flex align-items-center">
        <h2 id="form" class="logotext mb-3 mt-4">Форма</h2>
        ...
        <form action="" method="POST" class="mt-3 form">
            ...
            <br/>
            <label>
                Выберите дату вашего рождения:<br/>
            ...
            <label>
                Ваш пол:<br/>
                <input name="radio1" type="radio" value="male" checked="checked"> Мужской<br/>
            </label>
            <label>
            ...
            <label>
                ...
                <br/>
                <textarea name="biography" placeholder="Ваша биография" style="height: 100px;width:400px ;"></textarea>
            </label>
            <br/>
            <br/>
            <label>
